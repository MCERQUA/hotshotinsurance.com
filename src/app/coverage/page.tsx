      ...
      <main>
        <section className="relative pt-32 pb-16 md:pt-40 md:pb-20 overflow-hidden">
          ...
          <div className="container-tight text-center relative z-10">
            <FadeIn>
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/15 text-cream text-xs font-heading font-bold uppercase tracking-[0.18em] border border-white/25">Coverage Area</span>
              <h1 className="mt-5 font-heading font-extrabold text-white text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
                ...
                <span className="text-gold">{COPY.coveragePage.h1Highlight}</span>
              </h1>
              <p className="mt-6 text-lg md:text-xl text-cream/90 leading-relaxed max-w-2xl mx-auto">{COPY.coveragePage.lead}</p>
            </FadeIn>
          </div>
        </section>
          ...
          <div className="container-tight">
            ...
            <FadeIn className="mt-10">
              <div className="rounded-3xl bg-espresso text-cream p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div><p className="font-heading font-extrabold text-2xl">Featured regions</p><p className="text-cream/75 mt-1">Dedicated pages for key hotshot regions.</p></div>
