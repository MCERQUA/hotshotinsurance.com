...
export function Stats() {
  return (
    <section className="relative overflow-hidden bg-espresso text-cream py-16 md:py-20">
      <div className="absolute inset-0 opacity-60" style={{ background: "radial-gradient(circle at 18% 30%, rgba(245,158,11,0.18) 0%, transparent 45%), radial-gradient(circle at 82% 70%, rgba(30,77,140,0.22) 0%, transparent 50%)" }} aria-hidden />
