      ...
      <div className="container-tight">
        <FadeIn>
          <div className="relative overflow-hidden rounded-[2rem] md:rounded-[2.5rem] bg-espresso px-7 py-12 md:p-14 text-center shadow-warm-lg">
            <div className="absolute inset-0 opacity-70" style={{ background: "radial-gradient(circle at 20% 20%, rgba(245,158,11,0.18) 0%, transparent 45%), radial-gradient(circle at 80% 80%, rgba(30,77,140,0.22) 0%, transparent 50%)" }} aria-hidden />
